...
export function buildDraftFollowUpSystemPrompt(
  ...
  return `You are ${agentName}, Norvar's ${agent === "nora" ? "compliance chat assistant" : "regulatory assessment agent"}. The user completed an agreement draft with Scribe and is asking a follow-up about ${scope}
